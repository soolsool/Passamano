	...
	<div class="row">
		...
		<div class="row">
			...
			<form action="/seller/updateProduct.do" method="post" enctype="multipart/form-data" class="row g-3">
				...
				<div class="w-75">
					<div class="row mb-3">
						<label for="id" class="col-sm-3 form-label text-end">상품</label>
						<div class="col-sm-9">	
					...
					<div class="row mb-3">
						...
						<label for="productQty" class="col-sm-3 form-label text-end">수량</label>
						<div class="col-sm-3">
					...
					<div class="d-flex text-end justify-content-center buttonArea">
						<button type="submit" class="btn btn-outline-success d-block mx-2">수정</button>
