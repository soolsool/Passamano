...
.btn-order-cancel:hover, .btn-review:hover, .btn-cancel-check:hover,
	.btn-month:hover {
...
.btn-order-cancel:active, .btn-review:active, .btn-cancel-check:active,
	.btn-month:active {
	background-color: #28a745;
	color: white;
}
		...
		<div class="row">
			...
			<div class="col-8">
				...
				<div class="col-10 content text-center">
					<!-- 실제 본문 영역 시작 -->
					<div class="mypage-item"><%@ include
							file='/mypage/orderlist.jsp'%></div>
					<!-- 실제 본문 영역 끝 -->
				</div>
			</div>
			<div class="col-2"></div>
