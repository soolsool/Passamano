		...
		<div class="col-8 text-center" id="searchMenu">
			...
			<div class="d-inline mx-2" id="searchBox">
				<form action="/search.do" method="get" class="d-inline" id="searchKeyword">
					<input type="text" class="align-items-end border-bottom border-success border-2" id="search" name="search" placeholder="검색어를 입력하세요" style="border:none;">
	...
	<div class="row">
			...
			<div class="col-8">
				...
				<div id="goToTop" onclick="goToTheTop()">
					<svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#ffffff" class="bi bi-arrow-up-circle" viewBox="0 0 16 16">
